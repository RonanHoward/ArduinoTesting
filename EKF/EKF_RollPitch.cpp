...
EKF_RollPitch::EKF_RollPitch(float P0, float *Q0, float *R0) {
  phi_rad = 0.0f;
  theta_rad = 0.0f;
...
void EKF_RollPitch::predict(float gx, float gy, float gz, float T) {
...
void EKF_RollPitch::update(float ax, float ay, float az) {
