...
This parallel PID controller is characterized by Simulink model  gimbaledRocket3DOFR0V7.slx
Sample period T = 1mS.  Time constant t = 50mS.
Measurement and control are RADIANS.
